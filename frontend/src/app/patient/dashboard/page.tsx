  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const token = sessionData?.session?.access_token || (typeof window !== 'undefined' ? (localStorage.getItem('medivault_auth_token') || localStorage.getItem('medivault_demo_jwt')) : '') || '';
